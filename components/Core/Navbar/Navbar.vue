...
<script setup>
import { ArrowRightOnRectangleIcon, Bars3Icon, DocumentIcon, DocumentTextIcon, HomeIcon, MapPinIcon, PhotoIcon, ReceiptRefundIcon, UserCircleIcon, UserPlusIcon, XMarkIcon } from "@heroicons/vue/24/solid";
