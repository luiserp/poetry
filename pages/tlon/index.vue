  ...
  <NuxtLayout>
    ...
    >
      <p class="select-none text-lg leading-10">
        ...
        había declarado que los espejos y la cópula son <Dropdown
          :options="[
        ...
        />, porque
        multiplican el número de los hombres. Le pregunté el origen de esa
        memorable sentencia y me contestó que The Anglo-American Cyclopaedia la
        ...
        />
        . Confieso que asentí con alguna incomodidad. Conjeturé
        ...
        estéril de uno de los atlas de Justus Perthes fortaleció mi duda. Al día
        siguiente, Bioy me llamó desde Buenos Aires. Me dijo que tenía a la
        vista el artículo sobre Uqbar, en el volumen XXVI de la Enciclopedia. No
        constaba el nombre del heresiarca, pero sí la noticia de su doctrina,
        formulada en palabras casi idénticas a las repetidas por él, aunque -tal
        vez- literariamente inferiores. Él había recordado: Copulation and
        mirrors are abominable. El texto de la Enciclopedia decía: Para uno de
        esos gnósticos, el visible universo era una ilusión o (más precisamente)
        un sofisma. Los espejos y la paternidad son abominables (mirrors and
        ...
        sur y que en las islas de ese delta procrean <Dropdown
          :options="[
        ...
        supimos que a raíz de las persecuciones religiosas del siglo trece, los
        ...
        literatura de Uqbar era de carácter
        <Dropdown
          :options="[
        ...
        Haslam: History of the Land Called Uqbar, 1874-figura en los catálogos
        de librería de Bernard Quaritch.1 El primero, Lesbare und lesenswerthe
        Bemerkungen über das Land Ukkbar in Klein-Asien, data de 1641 y es obra
        de Johannes Valentinus Andreä. El hecho es significativo; un par de años
        después, di con ese nombre en las inesperadas páginas de De Quincey
        (Writings, decimotercero volumen) y supe que era el de un teólogo alemán
        que a principios del siglo XVII describió la imaginaria comunidad de la
        Rosa-Cruz -que otros luego fundaron, a imitación de lo prefigurado por
        él.
        <br />
